...
<head>
  ...
  <title>EJ Cadastrar Empresa Jr</title>
</head>
<body>
    ...
    <div class="row mar20" >
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="inner-section">
          <form method="post" action="{{ url('enterprise/new') }}">
          @csrf
            <div class="mar20 inside-form">
              <h2 class="font_white text-center">Cadastre sua Empresa Junior</h2>
              ...
              <div class="footer text-center">
                <button href="" class="btn btn-neutral btn-round btn-lg">Concluir</button>
              </div>
            </div>
          </form>
        </div>
